...
const copy = {
  ...
  title: {
    ...
    de: 'Ausgewählte Nachweise.',
    fr: 'Preuves sélectionnées.',
    es: 'Evidencia seleccionada.',
    ar: 'أدلة مختارة.',
  },
  intro: {
    en: 'Public artifacts, reports, and repositories behind the portfolio claims.',
    de: 'Öffentliche Artefakte, Berichte und Repositorien hinter den Aussagen im Portfolio.',
    fr: 'Artefacts publics, rapports et dépôts derrière les affirmations du portfolio.',
    es: 'Artefactos públicos, informes y repositorios detrás de las afirmaciones del portfolio.',
    ar: 'الروابط العامة والتقارير والمستودعات التي تدعم ما يظهر في البورتفوليو.',
  },
  caseStudy: { en: 'Case study', de: 'Case Study', fr: 'Étude de cas', es: 'Caso de estudio', ar: 'دراسة حالة' },
