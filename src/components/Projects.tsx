        ...
        <div className="cd-projects-grid">
          ...
          <a href="https://faultrix.com" target="_blank" rel="noopener noreferrer" className="cd-project-featured reveal">
           ...
           <a href="https://github.com/ahmed-3m/OOD-diffusion-detector" target="_blank" rel="noopener noreferrer" className="cd-project-card reveal">
             ...
             <div className="cd-pc-metric">99.03<span>% AUROC (CIFAR-10)</span></div>
           </a>
          ...
          {/* YOLO Occluded Detection */}
          <a
            href="https://github.com/ahmed-3m/Occluded-Object-Detection-With-Tracking"
            target="_blank"
            rel="noopener noreferrer"
            className="cd-project-card reveal"
          >
            <div className="cd-pc-eyebrow">M.Sc. Coursework · JKU Linz · 2023</div>
            <div className="cd-pc-title">Occluded Object Detection</div>
            <div className="cd-pc-desc">
              YOLO-based pipeline for detecting occluded objects with real-time
              centroid tracking using OpenCV. Multi-object tracking under heavy
              occlusion scenarios.
            </div>
          </a>
          ...
          <a
            ...
            className="cd-project-card reveal"
          >
            <div className="cd-pc-eyebrow">Karunya University · BCI Research · 2023</div>
