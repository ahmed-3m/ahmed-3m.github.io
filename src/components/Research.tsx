...
const copy = {
  ...
  summaryResultText: {
    ...
    de: '99.03% +/- 0.07% AUROC auf CIFAR-10 airplane-vs-rest (binaer, Einzelklasse, 3-Seed-Mittel) mit +6.5 Prozentpunkten gegenueber der Basis ohne Separation.',
    fr: '99.03% +/- 0.07% AUROC sur CIFAR-10 airplane-vs-rest (binaire, classe unique, moyenne 3 seeds) avec un gain de +6.5 points face a la baseline sans separation.',
    es: '99.03% +/- 0.07% AUROC en CIFAR-10 airplane-vs-rest (binaria, clase unica, media 3 seeds) con una mejora de +6.5 puntos sobre la base sin separacion.',
  ...
  thesisTitle: { en: 'Conditional Diffusion Models as Generative Classifiers for Out-of-Distribution Detection in Inkjet Print Quality Control', de: 'Konditionale Diffusionsmodelle als generative Klassifikatoren fuer OOD-Erkennung in der Inkjet-Druckqualitaetskontrolle', fr: 'Modeles de diffusion conditionnels comme classificateurs generatifs pour detection OOD dans le controle qualite impression inkjet', es: 'Modelos de difusion condicional como clasificadores generativos para deteccion OOD en control de calidad de impresion inkjet', ar: 'نماذج الانتشار الشرطية كمصنفات توليدية لكشف الخارج عن التوزيع في مراقبة جودة الطباعة النافثة' },
