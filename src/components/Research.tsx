    ...
    <section id="research" className="py-20 max-w-6xl mx-auto px-5">
      ...
      >
        ...
        <ul className="space-y-2 text-slate-600 dark:text-slate-300">
          <li>📄 Motor Imagery Classification Based Brain-Computer Interface for Rehabilitation</li>
          <li>📄 Reading Thoughts Using GANs</li>
          <li>📄 Diffusion-Based Multi-class Defect Detection: A Generative Approach to Industrial QC</li>
        </ul>
      </motion.div>
    </section>
  );
