...
const copy = {
  ...
  intro: {
    ...
    de: 'Öffentliche GitHub-Aktivität, zur Build-Zeit eingebettet — keine Live-Abfragen auf der Seite.',
    fr: 'Activité GitHub publique, intégrée au build — aucun fetch en direct sur la page.',
    es: 'Actividad pública de GitHub, integrada en el build — sin peticiones en vivo en la página.',
  ...
  empty: {
    ...
    de: 'Noch keine öffentliche Aktivität vorhanden.',
...
const typeLabels: Record<string, TranslationMap> = {
  ...
  PublicEvent: { en: 'Public', de: 'Öffentlich', fr: 'Public', es: 'Público', ar: 'عام' },
