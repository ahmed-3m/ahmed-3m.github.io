...
export const caseStudies: CaseStudy[] = [
  {
    ...
    summary: {
      ...
      de: 'Konditionale Diffusionsmodelle als generative Klassifikatoren für OOD-Erkennung mit Separation Loss und 99.03% +/- 0.07% AUROC auf einem Within-CIFAR Airplane-vs-Rest-Binary-Split (einzelne ID-Klasse).',
      fr: 'Modèles de diffusion conditionnels utilisés comme classificateurs génératifs pour la détection OOD avec 99.03% +/- 0.07% AUROC sur un split binaire airplane-vs-rest within-CIFAR (classe ID unique).',
      es: 'Modelos de difusión condicional usados como clasificadores generativos para detección OOD con 99.03% +/- 0.07% AUROC en un split binario airplane-vs-rest within-CIFAR (clase ID única).',
    ...
    problem: {
      ...
      fr: "Construire un détecteur OOD plus stable qui ne dépende pas seulement de la confiance du classificateur.",
      es: 'Construir un detector OOD más estable que no dependa solo de la confianza del clasificador.',
    ...
    role: {
      ...
      fr: 'Auteur du mémoire, modélisation, expériences, évaluation et analyse.',
      es: 'Autor de la tesis, modelado, experimentos, evaluación y análisis.',
  ...
  },
  {
    ...
    summary: {
      ...
      de: 'Eine öffentliche YOLO + Conditional-Diffusion-Pipeline für industrielle Druckqualitätskontrolle auf FTI_Zer0P.',
      fr: 'Une pipeline publique YOLO + diffusion conditionnelle pour le contrôle qualité industriel sur FTI_Zer0P.',
      es: 'Una pipeline pública YOLO + difusión condicional para control de calidad industrial sobre FTI_Zer0P.',
    ...
    problem: {
      ...
      de: 'Die generative Klassifikationsidee in ein eingeschränktes industrielles Setting mit wenig Daten übertragen.',
      fr: "Transférer l'idée de classification générative vers un contexte industriel contraint avec peu de données.",
      es: 'Transferir la idea de clasificación generativa a un entorno industrial restringido con pocos datos.',
    ...
    role: {
      ...
      de: 'Machine-Vision-Forscher, verantwortlich für Evaluation und Benchmark-Analyse.',
      fr: "Chercheur en vision industrielle, responsable de l'évaluation et de l'analyse du benchmark.",
      es: 'Investigador de visión artificial, responsable de evaluación y análisis del benchmark.',
  ...
  },
  {
    ...
    summary: {
      ...
      de: 'Ein KI-gestütztes SaaS für Bauqualitätskontrolle, solo von null bis Produktion gebaut.',
      fr: 'Un SaaS de contrôle qualité construction par IA construit en solo de zéro à la production.',
      es: 'Un SaaS de control de calidad en construcción con IA construido en solitario de cero a producción.',
    ...
    problem: {
      ...
      es: 'Convertir hábitos de investigación en un producto práctico que ahorre tiempo a los inspectores.',
      ar: 'تحويل عقلية البحث إلى منتج عملي يوفر الوقت للمفتشين ويولد تقارير موثوقة.',
    },
    role: {
      en: 'Full-stack builder across product, UX, AI workflow, and deployment.',
      de: 'Full-Stack-Builder über Produkt, UX, AI-Workflow und Deployment hinweg.',
      fr: "Constructeur full-stack sur le produit, l'UX, le workflow IA et le déploiement.",
      es: 'Constructor full-stack en producto, UX, flujo de IA y despliegue.',
      ar: 'الباني المتكامل للمنتج وتجربة المستخدم وسير عمل الذكاء الاصطناعي والنشر.',
    },
    approach: [
